...
% main.m
%
% Model exported on Jun 18 2016, 22:09 by COMSOL 5.2.0.220.
...
model.param.remove('d');
model.param.remove('theta_i');
model.param.remove('freq0');
model.param.remove('lambda');
model.param.remove('W');
model.param.remove('loss');
model.param.remove('R');
model.param.remove('zr');
model.param.remove('theta_r');
model.param.remove('period');
model.param.remove('d_nr_max');
model.param.remove('loss_a');
model.param.remove('nop');
model.param.remove('sigma');
model.param.remove('PMLH');
model.param.remove('c1');
model.param.remove('c3');
model.param.remove('c2');
model.param.remove('x0');
model.param.set('d', 'period/8');
model.param.set('D', '0.04[m/s]*freq0/freq1');
model.param.set('d_nr_max', '3.3890625');
...
model.param.set('theta_i', '30*pi/180');
model.param.set('W', '2*R');

model.sol('sol2').feature('v1').feature('comp2_p2').set('solvefor', true);
model.sol('sol2').feature('v1').feature('comp2_p2').set('comp', 'comp2.p2');
model.sol('sol2').feature('v1').feature('comp2_p2').set('compintstatuse', 'off');
model.sol('sol2').feature('v1').feature('comp2_p2').set('compintstat', []);
model.sol('sol2').feature('v1').feature('comp1_p').set('solvefor', true);
model.sol('sol2').feature('v1').feature('comp1_p').set('comp', 'comp1.p');
model.sol('sol2').feature('v1').feature('comp1_p').set('compintstatuse', 'off');
model.sol('sol2').feature('v1').feature('comp1_p').set('compintstat', []);
model.sol('sol2').feature('v1').set('control', 'freq');
model.sol('sol2').feature('v1').feature('comp2_p2').set('solvefor', true);
model.sol('sol2').feature('v1').feature('comp2_p2').set('comp', 'comp2.p2');
model.sol('sol2').feature('v1').feature('comp2_p2').set('compintstatuse', 'off');
...
model.geom('geom1').feature('r2').set('pos', {'-int_W/2' '0'});
